...
7. To open the console automatically when the app launches, enable **Settings > Apps > IntuneSDKTest > Show Intune diagnostics on launch**. Note, this will only work when signed out of app.
